...
function onInit()
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_center|option_val_select", values = "on|select", baselabelres = "option_val_off", baseval = "off", default = "on", }, 
	});
	OptionsManager.registerOptionData({	sKey = "CWHR", bLocal = true, tCustom = { default = "on", }, });
	OptionsManager.registerOptionData({	sKey = "WSAV", bLocal = true, });
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_active", values = "active", baselabelres = "option_val_all", baseval = "all", default = "all", },
	});
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_append|option_val_random", values = "append|random", baselabelres = "option_val_off", baseval = "off", default = "append", },
	});
	OptionsManager.registerOptionData({	sKey = "RING", sGroupRes = "option_header_combat", });
	OptionsManager.registerOptionData({	
		sKey = "CTSI", sGroupRes = "option_header_combat",
		tCustom = { labelsres = "option_val_all|option_val_friendly", values = "on|friend", baselabelres = "option_val_off", baseval = "off", default = "on", },
	});
	OptionsManager.registerOptionData({	
		sKey = "RSHT", sGroupRes = "option_header_combat",
		tCustom = { labelsres = "option_val_all|option_val_friendly", values = "all|on", baselabelres = "option_val_off", baseval = "off", default = "on", },
	});
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_scale80|option_val_scale100", values = "80|100", baselabelres = "option_val_off", baseval = "off", default = "80", },
	});
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_tooltip|option_val_title|option_val_titlehover", values = "tooltip|on|hover", baselabelres = "option_val_off", baseval = "off", default = "tooltip", },
	});
	OptionsManager.registerOptionData({	
		sKey = "TFOW", sGroupRes = "option_header_token",
		tCustom = { labelsres = "option_val_on|option_val_pc", values = "on|pc", baselabelres = "option_val_off", baseval = "off", default = "pc", },
	});

	OptionsManager.registerOptionData({	
		sKey = "HRDD", sGroupRes = "option_header_houserule",
		tCustom = { labelsres = "option_val_x1|option_val_x1_5|option_val_raw", values = "x1|variant|raw", baselabelres = "option_val_default", baseval = "", default = "", },
	});
