...
function addDefaultHealthFeatures(tHealthFields)
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_bar|option_val_barhover|option_val_dot|option_val_dothover", values = "bar|barhover|dot|dothover", baselabelres = "option_val_off", baseval = "off", default = "dot", },
	});
	OptionsManager.registerOptionData({	
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_detailed", values = "detailed", baselabelres = "option_val_simple", baseval = "off", default = "off", },
	});
...
function addDefaultEffectFeatures()
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_icons|option_val_iconshover|option_val_mark|option_val_markhover", values = "on|hover|mark|markhover", baselabelres = "option_val_off", baseval = "off", default = "on", },
	});
	OptionsManager.registerOptionData({	
	...
	OptionsManager.registerOptionData({	
		...
		tCustom = { labelsres = "option_val_small|option_val_large", values = "small|large", baselabelres = "option_val_standard", baseval = "", default = "", },
	});
